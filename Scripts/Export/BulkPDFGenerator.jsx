...
if (nk.nikkudDoc) {
    ...
    nk.TARGET_LETTER_SMALL_STYLE = nk.doc.paragraphStyleGroups
        .itemByName("Directions")
        .paragraphStyles.itemByName("Target Letter Small");
...
function randomizeNikkud() {
    ...
    for (i = 0; i < findsLength; i++) {
        ...
        if (
            mazeStyleExists &&
            finds[i].parentTextFrames[0].appliedObjectStyle.name === "Maze" &&
            finds[i].contents.match("אחהע") === null
        ) {
...
function setGREPPrefs() {
    ...
    with (app.findChangeGrepOptions) {
        if (Object.prototype.hasOwnProperty.call(app.findChangeGrepOptions, "includeFootnotes"))
            includeFootnotes = true;
        if (Object.prototype.hasOwnProperty.call(app.findChangeGrepOptions, "includeHiddenLayers"))
            includeHiddenLayers = true;
        if (Object.prototype.hasOwnProperty.call(app.findChangeGrepOptions, "includeLockedLayersForFind"))
            includeLockedLayersForFind = true;
        if (Object.prototype.hasOwnProperty.call(app.findChangeGrepOptions, "includeLockedStoriesForFind"))
            includeLockedStoriesForFind = true;
        if (Object.prototype.hasOwnProperty.call(app.findChangeGrepOptions, "includeMasterPages"))
...
function tidyFile() {
    ...
    var constructed =
        "שׁ|שׂ|שּׁ|שּׂ|אַ|אָ|אְ|בּ|גּ|דּ|הּ|וּ|זּ|טּ|יּ|ךּ|כּ|לּ|מּ|נּ|סּ|ףּ|פּ|צּ|קּ|רּ|שּ|תּ|וֹ|לֹּ|לֹ".split("|");
    app.findGrepPreferences = app.changeGrepPreferences = null;
